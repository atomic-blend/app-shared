...
class BottomNavigation extends StatelessWidget {
  ...
  const BottomNavigation({
    ...
    this.onTap, required this.onPrimaryMenuSelected, required this.onSecondaryMenuSelected,
  });
