        ...
        final textField = Stack(
          children: [
              ...
              child: TextFormField(
                ...
                style:
                    ...
                    getTextTheme(context).bodyMedium!.copyWith(
                      color: widget.textColor ?? getTheme(context).onSurface,
                    ),
                decoration: InputDecoration(
                  ...
                  hintStyle: getTextTheme(
                    context,
                  ).bodyMedium!.copyWith(color: Colors.grey[700]),
                  isDense: true,
            ...
            if (widget.trailing != null)
              Positioned(right: 0, top: 0, bottom: 0, child: widget.trailing!),
          ],
        );
              ...
              if (widget.labelDescription != null)
                Padding(
                  ...
                  child: Text(
                    ...
                    style: getTextTheme(
                      context,
                    ).bodySmall!.copyWith(color: Colors.grey[700]),
                  ),
                ),
            ],
          );
